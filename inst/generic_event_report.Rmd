...
This chart shows how actual  `r owner_name` consumption has changed relative to normal for the day of week and weather conditions since the event started on `r event_start` (the event period is indicated in green and the change is indicated by arrows).
